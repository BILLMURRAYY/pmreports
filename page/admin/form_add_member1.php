                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6" data-select2-id="56">
                                        <div class="form-group" data-select2-id="55">
                                            <label>ชื่อ</label>
                                            <input type="text" name="name" class="form-control" required placeholder="กรอกชื่อจริง" value="" minlength="2">
                                        </div>
                                    </div>
                                    <div class="col-md-6" data-select2-id="56">
                                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" name="username" id="m_email" placeholder="กรอกอีเมล" required>
                                    </div>
                                    <div class="col-md-6" data-select2-id="56">
