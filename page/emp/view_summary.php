                                ...
                                <div align="center">
                                    <form method="post" action="view_summary.php">
                                        <div class="contain">
                                            <div class="row">
                                                ...
                                                <select class="col-3 select2 form-control" name="job_type" id="job_type">
                                                    <?php
                                                ...
                                                <label class="col-2 col-form-label"> เลือกปี </label>

                                                <select class="col-2 select2 form-control" name="year" id="year">
                                                    <?php for ($year = 2022; $year <= date('Y'); $year++) { ?>
                                                        <option value="<?= $year ?>" <?= $getYear == $year ? 'selected' : '' ?>><?php echo ($year + 543) ?></option>
                                                    <?php  } ?>
                                                </select>
                                                <input type="submit" class="col-2 btn btn-success  " name="btsearch" id="btsearch" value="ค้นหารายงาน" />
                                            </div>
                                        </div>
                                    </form>
                                    <br>
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <td width="30%" align="center">เดือน</td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-success">ดำเนินการสำเร็จ</div>
                                                    </td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-warning">กำลังดำเนินการ</div>
                                                    </td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-danger">ยังไม่ได้ดำเนินการ</div>
                                                    </td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-primary">จำนวนที่รายงาน</div>
                                                    </td>
                                                </tr>
                                            </thead>
                                            <?php
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-success"><?php echo $total_report_suc ?></div>
                                                    </td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-warning"><?php echo $total_report_progress ?></div>
                                                    </td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-danger"><?php echo $total_report_fail ?></div>
                                                    </td>
                                                    <td>
                                                        <div style="text-align:center;font-weight:normal;white-space:normal;border-radius:5px;padding:5px;" class="bg-primary"><?php echo $total_report ?></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
